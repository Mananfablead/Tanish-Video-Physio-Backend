...
router.put('/admin/hero', cmsController.updateHero);

// Steps Section
router.get('/admin/steps', cmsController.getStepsAdmin);
router.post('/admin/steps', cmsController.createStep);
router.put('/admin/steps/:id', cmsController.updateStep);
router.delete('/admin/steps/:id', cmsController.deleteStep);

// Conditions Section
router.get('/admin/conditions', cmsController.getConditionsAdmin);
router.put('/admin/conditions', cmsController.updateConditions);
...
router.put('/admin/featuredTherapist', cmsController.updateFeaturedTherapist);
...
router.put('/admin/about', cmsController.updateAbout);
